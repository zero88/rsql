...
public final class NonExistsBuilder extends AbstractComparisionCriteriaBuilder {

    public static final ComparisonOperator OPERATOR = new ComparisonOperator("=null=", "=isn=");
